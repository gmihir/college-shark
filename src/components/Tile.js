                    ...
                    <hr></hr>
                        <div className="info-container">
                            <div className="information-div">
                                <h3>Population: </h3>
                                <h3>{localStorage.getItem('userState') === this.props.State ? "In State Tuition: " : "Out of State Tuition: "}</h3>
                                <h3>App. Fee: </h3>
                            ...
                            <div className="info-div-number">
                                ...
                                <h3>${localStorage.getItem('userState') === this.props.State ? this.props.Tuition : this.props.TuitionOOS}</h3>
